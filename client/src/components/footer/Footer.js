...
function Footer() {
  ...
  window.addEventListener("resize", FormSize);
            ...
            <div className="row p-0 m-0">
              <form action="#" method="post">
                <div className={!form ? "form_item" : ""}>
                  <div className="col-lg-8 col-md-9 col-sm-9 col-12 p-0">
                  ...
                  <div className="col-lg-4 col-md-3 col-sm-3 col-12 p-0 d-flex justify-content-end ">
                    <button
                      className={
                        form
